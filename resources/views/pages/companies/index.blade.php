...
@section('content')
    <x-common.page-breadcrumb pageTitle="View Company" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="flex flex-col gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Company List</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage all companies from here.</p>
            </div>
        ...
        <div class="overflow-x-auto p-4 sm:p-6">
            <table id="companies-table" class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
                <thead class="text-xs uppercase text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                    <tr>
                        <th class="px-4 py-3">#</th>
                        <th class="px-4 py-3">Company Name</th>
                        <th class="px-4 py-3">Company Code</th>
