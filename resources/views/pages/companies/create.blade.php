...
@section('content')
    <x-common.page-breadcrumb pageTitle="Add Company" />

    <form action="{{ route('companies.store') }}" method="POST">
        @csrf
        <x-common.component-card title="Add Company" desc="Fill in the company details below.">
            @include('pages.companies.partials.form')

            <div class="flex items-center gap-3 pt-2">
                <x-ui.button type="submit" variant="primary">Save Company</x-ui.button>
