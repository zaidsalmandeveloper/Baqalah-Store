...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Quotation" />

    <form action="{{ route('quotations.update', $quotation) }}" method="POST">
        @csrf
        @method('PUT')
        <x-common.component-card title="Edit Quotation" desc="Update quotation details and line items.">
            ...
            <div class="flex items-center gap-3 pt-2">
                <x-ui.button type="submit" variant="primary">Update Quotation</x-ui.button>
